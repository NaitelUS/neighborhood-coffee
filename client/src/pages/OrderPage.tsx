...
interface CustomerInfoFormProps {
  ...
  children?: React.ReactNode; // 👈 para insertar el botón desde OrderPage
}
...
export default function CustomerInfoForm({
  ...
  // Actualiza parent cuando cambian valores
  React.useEffect(() => {
  ...
  // Manejar el submit (validación + dejar que Netlify reciba el form)
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (form.formState.isValid) {
      onInfoChange(form.getValues());
      (e.target as HTMLFormElement).submit(); // 👈 deja que Netlify procese el envío
    }
  };
      ...
      <CardContent>
        <Form {...form}>
          ...
          >
            ...
            {/* Botón que viene desde OrderPage */}
            {children}
          </form>
        </Form>
      </CardContent>
